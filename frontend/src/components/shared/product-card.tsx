      ...
      <div className="flex flex-col flex-1 px-5 pb-5 gap-3">
        ...
        <div className="mt-auto space-y-2">
          ...
          {product.price !== null ? (
            ...
            <span className="block text-sm text-warm-gray-600 flex items-center gap-1">
              Цену уточняйте
              <span className="inline-flex items-center justify-center w-4 h-4 rounded-full border border-warm-gray-300 text-[10px] text-warm-gray-300">i</span>
            </span>
          )}

          <Button
            className="w-full rounded-xl bg-gradient-to-r from-[#C66B54] to-[#A85542] text-white font-semibold hover:shadow-md hover:shadow-[#C66B54]/20 transition-all duration-300"
          >
